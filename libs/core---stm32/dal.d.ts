...
declare const enum DAL {
    ...
    CFG_PIN_BLE_SPI_MISO = 183,
    CFG_PIN_BLE_SPI_MOSI = 184,
    CFG_PIN_BLE_SPI_SCLK = 185,
    CFG_PIN_BLE_SPI_CS = 186,
    CFG_PIN_BLE_SPI_IRQ = 187,
    CFG_PIN_BLE_RST = 188,
    CFG_PIN_WIFI_ISM43362_MOSI = 189,
    CFG_PIN_WIFI_ISM43362_MISO = 190,
    CFG_PIN_WIFI_ISM43362_SCK = 191,
    CFG_PIN_WIFI_ISM43362_CS = 192,
    CFG_PIN_WIFI_ISM43362_COMMAND_DATA_READY = 193,
    CFG_PIN_WIFI_ISM43362_RESET = 194,
    CFG_PIN_WIFI_ISM43362_WAKE_UP = 195,
