...
declare const enum DAL {
    ...
    CFG_PIN_BTN_USER = 72,
    CFG_PIN_RESET = 73,
    CFG_PIN_HTS221_SDA = 74,
    CFG_PIN_HTS221_SCL = 75,
    CFG_PIN_LPS22HB_SDA = 76,
    CFG_PIN_LPS22HB_SCL = 77,
    CFG_PIN_VL53L0X_SDA = 78,
    CFG_PIN_VL53L0X_SCL = 79,
    CFG_PIN_VL53L0X_SHUT = 80,
    CFG_PIN_LSM6DSL_SDA = 81,
    CFG_PIN_LSM6DSL_SCL = 82,
    CFG_PIN_BLE_SPI_MISO = 83,
    CFG_PIN_BLE_SPI_MOSI = 84,
    CFG_PIN_BLE_SPI_SCLK = 85,
    CFG_PIN_BLE_SPI_CS = 86,
    CFG_PIN_BLE_SPI_IRQ = 87,
    CFG_PIN_BLE_RST = 88,
