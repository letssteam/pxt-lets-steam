...
namespace bluetooth {
    ...
    */
    ...
    //% blockId=bluetooth_uart_read block="bluetooth uart|read until %del=ble_serial_delimiter_conv"
    ...
    */
     ...
     */
    //% blockId="ble_serial_delimiter_conv" block="%del"
    //% weight=1 blockHidden=true hidden=true
    export function delimiters(del: BLE_Serial_Delimiters): string {
