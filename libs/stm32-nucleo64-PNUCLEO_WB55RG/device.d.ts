...
declare namespace input {
    ...
    /**
     * Button connecting SW1 to GND.
     */
    //% block="button SW1" fixedInstance
    //% shim=pxt::getButton(0)
    const buttonSW1: Button;

    /**
     * Button connecting SW2 to GND.
     */
    //% block="button SW2" fixedInstance
    //% shim=pxt::getButton(1)
    const buttonSW2: Button;

    /**
     * Button connecting SW3 to GND.
     */
    //% block="button SW3" fixedInstance
    //% shim=pxt::getButton(2)
    const buttonSW3: Button;
}
